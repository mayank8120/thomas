...
const DetailPageGreatRd = () => {
                            ...
                            <div className="detailLeftSec">
                                        ...
                                        <Carousel activeIndex={index} onSelect={handleSelect} >
                                            ...
                                            <CarouselItem>
                                                <img
                                                    ...
                                                    src={require('../../assets/img/detailImagelist.png').default}
                                                    alt="First slide"
                                                />
                                            </CarouselItem>
                                ...
                                <div className="detailTextSec itemWebsite listhub">
                                    <div className="d-flex align-items-center topHeadSec">
                                        ...
                                        <div className="ml-auto priceTagDet ml-autoImp" >
                                ...
                                <div className="SectionBlock responsive15">
                                    <h3 className="font-weight700 colorBlue fontSize18">About Property <span
                                        className="font-weight400 secondaryColor fontSize14 "><i>of 405 Great Rd #16, Acton, MA 01720</i></span></h3>
                                ...
                                <div className="d-flex align-items-center availSec responsive15 flex-wrap mt-4 pb-0">
                                    <div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <h3 className="font-weight700 colorBlue fontSize18">Lease Terms<span
                                                className="font-weight400 secondaryColoe fontSize14"> for 405 Great Rd #16, Acton, MA
                                                01720</span></h3>
                                ...
                                <div className="fairmarketRent responsive15">
                                    <div className="d-flex align-items-center mobile-view">
                                        ...
                                        <h3 className="mb-0 font-weight700 colorBlue fontSize18">Fair Market Rents<span
                                            className="font-weight400 secondaryColor fontSize14"><i>of 405 Great Rd #16, Acton, MA 01720</i></span>
                                        </h3>
                                ...
                                <div className="SectionBlock responsive15 neighborhoodSec">
                                    <h3 className="font-weight700 colorBlue fontSize18">Neighborhoods Nearby<span
                                        className="font-weight400 secondaryColor fontSize14"><i>405 Great Rd #16, Acton, MA 01720</i></span></h3>
                                    <ul className="noMarginPad listStyleNone">
                                        <li>
                                ...
                                <div className="responsive15">
                                    <div className="titleHeading">
                                        <h3 className="font-weight700 colorBlue fontSize18">Schools Nearby <span
                                            className="font-weight400 secondaryColor fontSize14"><i>serving 405 Great Rd #16, Acton, MA
                                                01720</i></span></h3>
                                    </div>
                                ...
                                <div className="SectionBlock responsive15 availabilitySection">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="ml-auto">
                                            <p className="purpleText font-weight700 fontSize18 mb-0"><img
                                                src={require('../../assets/img/phoneColored.svg').default} />(626) 448-2699</p>
                                        </div>
                                    </div>
                                                ...
                                                <div className="card-body p-0">
                                                    ...
                                                    <div className="media d-flex align-items-center">
                                                        ...
                                                        <span className="imageCircle mr-15">
                                                            <img className="" src={require('../../assets/img/share.svg').default} />
                                                        </span>
                                                        ...
                                                        <div className="media-body ml-0">
                                                            ...
                                                            <p className="mb-0 fontSize12 secondaryColor">
                                                                120 center  sl auburn , CA, 2343223</p>
                                                            <a href="" className="purpleText">www.xyz.com</a>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <ul className="noMarginPad listStyleNone">
                                                                ...
                                                                <li>
                                                                    <div className="media">
                                                                        ...
                                                                        <a href="">
                                                                            <img className="brdrRadius4 wh64px" src='https://managers.rentalhousingdeals.com/images/l_thumbs/affordable-no-image.jpg' alt="" />
                                                                        </a>
    ...
    alt="Generic placeholder image" /> */}
                                                                        <div className="media-body">
                                                                            <a href="#"><h5 className="mt-0 fontSize16 font-weight500 mb-0">
                                                                                Arcadia APartments</h5></a>

                                                                            <p className="mt-0 mb-0 fontSize12 secondaryColor">
                                                                                120 awi manadsf ,los ANgeles, CA,890897</p>
                                                                            <ul
                                                    ...
                                                    <ul className="noMarginPad listTxt listStyleNone">
                                                        <li>
                                                            <div className="d-flex">
                                                                ...
                                                                <span className="colorBlue">124564334</span>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="d-flex">
                                                                ...
                                                                <span className="colorBlue">12</span>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="d-flex">
                                                        ...
                                                        <li>
                                                            <div className="d-flex">
                                                                ...
                                                                <span className="colorBlue">54%</span>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="d-flex">
                                                                ...
                                                                <span className="colorBlue">1232543534</span>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="d-flex">
                                                                ...
                                                                <span
                                                                    className="colorBlue">$123,342</span>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="d-flex">
                                                                ...
                                                                <span
                                                                    className="colorBlue">$234,234</span>
                                                            </div>
                                                        </li>
                                                    </ul>
...
export default DetailPageGreatRd;